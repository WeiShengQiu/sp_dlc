...
PopupLayouts[ButtonPopupTypes.BUTTONPOPUP_ANNEX_CITY] = function(popupInfo)
	...
	local OnAnnexClicked = function()
		...
		newCity:SendAndExecuteLuaFunction(newCity.SetNumRealBuilding, GameInfoTypes["BUILDING_PUPPET_GOVERNEMENT"],0)
		--newCity:SetNumRealBuilding(GameInfoTypes["BUILDING_PUPPET_GOVERNEMENT_FULL"],0)
		newCity:SendAndExecuteLuaFunction(newCity.SetNumRealBuilding, GameInfoTypes["BUILDING_PUPPET_GOVERNEMENT_FULL"],0)
