...
function UpdateUnitPortrait( unit )
	...
	if     unit:IsHasPromotion(GameInfoTypes["PROMOTION_CORPS_2"])
	and GameInfo.Unit_FreePromotions{ UnitType = GameInfo.Units[unit:GetUnitType()].Type, PromotionType = "PROMOTION_CORPS_2" }() == nil
	then
	    ...
	    elseif unit:GetDomainType() == DomainTypes.DOMAIN_SEA then
	      if GameInfo.Leader_Traits{ LeaderType = GameInfo.Leaders[Players[unit:GetOwner()]:GetLeaderType()].Type, TraitType = "TRAIT_FIGHT_WELL_DAMAGED" }()
	      and(GameInfo.Traits["TRAIT_FIGHT_WELL_DAMAGED"].PrereqPolicy == nil or (GameInfo.Traits["TRAIT_FIGHT_WELL_DAMAGED"].PrereqPolicy
	      and Players[unit:GetOwner()]:HasPolicy(GameInfoTypes[GameInfo.Traits["TRAIT_FIGHT_WELL_DAMAGED"].PrereqPolicy])))
	      then
	...
	elseif unit:IsHasPromotion(GameInfoTypes["PROMOTION_CORPS_1"])
	and GameInfo.Unit_FreePromotions{ UnitType = GameInfo.Units[unit:GetUnitType()].Type, PromotionType = "PROMOTION_CORPS_1" }() == nil
	then
	    if     unit:GetDomainType() == DomainTypes.DOMAIN_LAND then
	...
	if     unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_1"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_2"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_3"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_4"])
	then
		name = name .. " (-1000[ICON_SILVER_FIST])";
	elseif unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_2"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_3"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_4"])
	then
		name = name .. " (-900[ICON_SILVER_FIST])";
	elseif unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_1"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_3"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_4"])
	then
		name = name .. " (-800[ICON_SILVER_FIST])";
	elseif unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_3"])
	and    unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_4"])
	then
	...
	elseif unit:IsHasPromotion(GameInfoTypes["PROMOTION_MAXHP_REDUCE_4"])
	then
